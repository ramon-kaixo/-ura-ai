...
if ssh -o ConnectTimeout=2 ramon@${ASUS_HOST:-100.72.103.12} "cd ${ASUS_PATH:-/home/ramon/URA}/ura_ia_1972 && python3 -c 'from monitor.error_logger import ErrorLogger; print(\"OK\")'" > /dev/null 2>&1; then
...
if ssh -o ConnectTimeout=2 ramon@${ASUS_HOST:-100.72.103.12} "cd ${ASUS_PATH:-/home/ramon/URA}/ura_ia_1972 && python3 -c 'from monitor.mac_heartbeat import MacHeartbeat; print(\"OK\")'" > /dev/null 2>&1; then
...
if ssh -o ConnectTimeout=2 ramon@${ASUS_HOST:-100.72.103.12} "cd ${ASUS_PATH:-/home/ramon/URA}/ura_ia_1972 && python3 -c 'import monitor.snc; print(\"OK\")'" > /dev/null 2>&1; then
