...
class SystemCleaner:
    ...
    def get_disk_usage(self, path: str = "/") -> dict:
        ...
        try:
            ...
            logger.exception(f"Error obteniendo uso de disco: {e}")
            return {}
...
class LinuxCleaner(SystemCleaner):
    ...
    def clean_docker(self) -> float:
        ...
        try:
            ...
            logger.exception("Docker prune timeout")
            return 0
        except Exception as e:
            logger.exception(f"Error limpiando Docker: {e}")
            return 0
    ...
    def clean_apt_cache(self) -> float:
        ...
        try:
            ...
            logger.exception("apt-cache cleanup timeout")
            return 0
        except subprocess.CalledProcessError as e:
            logger.exception(f"Error ejecutando apt: {e}")
            return 0
        except Exception as e:
            logger.exception(f"Error limpiando apt: {e}")
            return 0
    ...
    def clean_pip_cache(self) -> float:
        ...
        try:
            ...
            logger.exception("pip cache purge timeout")
            return 0
        except Exception as e:
            logger.exception(f"Error limpiando pip: {e}")
            return 0
...
class MacCleaner(SystemCleaner):
    ...
    def clean_brew_cache(self) -> float:
        ...
        try:
            ...
            logger.exception("brew cleanup timeout")
            return 0
        except Exception as e:
            logger.exception(f"Error limpiando brew: {e}")
            return 0
    ...
    def clean_application_caches(self) -> float:
        ...
        try:
            ...
            logger.exception(f"Error limpiando caches: {e}")
            return 0
