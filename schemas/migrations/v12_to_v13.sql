...
-- PASO 1: Asegurar tabla op_assets (puede faltar en migraciones incrementales)
-- El schema completo la define, pero no tenía archivo de migración propio.
...
-- PASO 4: Índices para las nuevas columnas
...
-- PASO 5: Asegurar tabla op_memory (puede faltar en migraciones incrementales)
