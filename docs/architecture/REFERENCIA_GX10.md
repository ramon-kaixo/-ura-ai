...
- **Flujo de datos**: `agente POS externo → Bearer → proxy_contraste:8002 → Prometheus scrape → alert.rules`
- **Dependencias**: conectividad Tailscale saliente desde el nodo POS externo hacia `proxy_contraste:8002`
