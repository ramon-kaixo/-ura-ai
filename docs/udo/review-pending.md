...
| 2026-08-21 | Lote CIERRE-20260821 (d7dfc820..027fe8d8) | REVISADO en sesión: 2 correcciones aplicadas (pragmas pardon ef4c3318, FURB171 60dfad30); verificación objetiva con gates en cada commit (hooks verdes). Lote anterior 005b51c3..1ff71b68 queda CERRADO. |
| 2026-08-25 | TASK-20260825-002 | Auditoria timers/cron (TERM): HALLAZGO CRITICO ura-cleanup-auto.timer muerto por OnCalendar invalido desplegado — FIX APLICADO Y VERIFICADO (active, disparo 02:47); 9 timers del repo sanos; crontab sano; DERIVA: 66 unidades ura-* en /etc sin versionar; seccion anti-deriva anadida a audit_semanal.sh (1a8d3c50). Estado: PENDIENTE revision WEB para DONE. |
