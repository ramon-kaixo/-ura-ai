...
| Secretos | `OPENCODE_WEB_PASS=321000` viejo en secrets.env; TAILSCALE_AUTH_KEY y HCLOUD_TOKEN hardcodeados en `.bashrc` |
...
| `OPENCODE_WEB_PASS=321000` duplicado en secrets.env | Valor antiguo pre-F1 + append nuevo | Línea vieja eliminada (sed); único valor de 48 chars |
