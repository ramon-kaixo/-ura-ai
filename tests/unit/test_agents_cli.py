...
class TestAgentsCli:
    def test_modo_ciclo(self, monkeypatch) -> None:
        ...
        loop = mock.Mock()
        monkeypatch.setattr("motor.core.agents.cli.SelfHealingLoop", mock.Mock(return_value=loop))
    ...
    def test_modo_orquestar(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr("motor.core.agents.cli.Telemetria", mock.Mock(return_value=tele))
        monkeypatch.setattr("motor.core.agents.cli.Conciencia", mock.Mock(leer=lambda: {}))
        orq = mock.Mock()
        orq.decidir.return_value = ("ESPERAR", "estable")
        monkeypatch.setattr("motor.core.agents.cli.AgenteOrquestador", mock.Mock(return_value=orq))
    ...
    def test_modo_reparar_ok(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr("motor.core.agents.cli.AgenteReparador", mock.Mock(return_value=reparador))
        exit_codes = []
        ...
        monkeypatch.setattr("motor.core.agents.cli.sys.exit", _exit)
