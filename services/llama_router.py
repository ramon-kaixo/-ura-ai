...
def main():
    ...
    parser.add_argument("--host", default="127.0.0.1", help="Interfaz de red (default: 127.0.0.1)")
    ...
    try:
        ...
        server = make_server(args.host, args.port, application, server_class=ReuseAddrWSGIServer)
