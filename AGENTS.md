...
- **CLI**: `scripts/pro/ura-udo` — `create | show | update (--estado/--nota/--reserva/--agente_web/--agente_terminal/--instrucciones/--restricciones/--force) | reserve (--add/--clear/--force) | check [rutas] | context TASK-ID | list [ESTADO] | status | verify TASK-ID`
