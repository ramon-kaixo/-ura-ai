...
from core.memoria.ingesto import IngestionWatcher, procesar_archivo
...
__all__ = [
    ...
    "extraer_archivo", "EXTRACTORES", "comprimir_a_ideas", "almacenar_ideas",
    "buscar_ideas", "marcar_antiguas", "buscar_y_aprender",
