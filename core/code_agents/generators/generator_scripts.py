#!/usr/bin/env python3
"""
URA Code Generator - Scripts
Genera scripts de automatización
"""

import ast
from connectors.ollama_connector import completar

SYSTEM_PROMPT = """Eres un experto en automatización. Generas scripts Python ejecutables con argparse, manejo de señales SIGTERM y logging. El script debe poder correrse standalone y dentro de URA."""
...
if __name__ == "__main__":
    print("=== TEST GENERATOR SCRIPTS ===")
    resultado = generar("Crea un script para limpiar logs antiguos")
