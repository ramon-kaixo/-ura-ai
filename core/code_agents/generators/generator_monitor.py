#!/usr/bin/env python3
"""
URA Code Generator - Monitor
Genera módulos de monitoreo y métricas
"""

import ast
from connectors.ollama_connector import completar

SYSTEM_PROMPT = """Eres un experto en observabilidad. Generas módulos con función monitorear() que devuelve métricas en formato compatible con Prometheus/Grafana y función bucle(intervalo) para ejecución continua."""
...
if __name__ == "__main__":
    print("=== TEST GENERATOR MONITOR ===")
    resultado = generar("Crea un módulo de monitoreo de CPU")
