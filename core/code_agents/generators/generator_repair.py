#!/usr/bin/env python3
"""
URA Code Generator - Repair
Genera parches de auto-reparación desde tracebacks
"""

import ast
from connectors.ollama_connector import completar

SYSTEM_PROMPT = """Eres un experto en auto-reparación de código. Recibes un error con su traceback y el código fuente. Generas un parche mínimo que resuelve el problema sin cambiar la interfaz pública del módulo."""
...
if __name__ == "__main__":
    print("=== TEST GENERATOR REPAIR ===")
    resultado = generar("Crea un parche para NameError: variable no definida")
