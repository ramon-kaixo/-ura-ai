#!/usr/bin/env python3
"""
URA Code Generator - Config
Genera archivos de configuración JSON
"""

import ast
from connectors.ollama_connector import completar

SYSTEM_PROMPT = """Generas archivos de configuración JSON válidos para URA con valores por defecto sensatos, comentarios explicativos como campos _description, y validación de esquema."""
...
if __name__ == "__main__":
    print("=== TEST GENERATOR CONFIG ===")
    resultado = generar("Crea configuración para un agente de monitoreo")
