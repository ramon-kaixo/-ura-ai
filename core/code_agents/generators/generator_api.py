#!/usr/bin/env python3
"""
URA Code Generator - API
Genera conectores REST e integraciones externas
"""

import ast
from connectors.ollama_connector import completar

SYSTEM_PROMPT = """Eres un experto en integraciones REST. Generas conectores Python usando solo requests o urllib. Siempre incluyes timeout, manejo de errores, y devuelves {ok, data, error}. Nunca hardcodeas credenciales."""
...
if __name__ == "__main__":
    print("=== TEST GENERATOR API ===")
    resultado = generar("Crea un conector para la API de OpenWeather")
