#!/usr/bin/env python3
"""
URA Code Generator - SQL
Genera queries SQLite parametrizadas
"""

import ast
from connectors.ollama_connector import completar

SYSTEM_PROMPT = """Eres un experto en SQLite. Generas queries parametrizadas, nunca con f-strings para evitar injection. Incluyes CREATE TABLE si es necesario, índices para queries frecuentes y manejo de transacciones."""
...
if __name__ == "__main__":
    print("=== TEST GENERATOR SQL ===")
    resultado = generar("Crea una query para insertar usuarios")
